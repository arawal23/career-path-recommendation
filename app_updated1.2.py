...
def build_multistep_sankey(start_role, domain, model_name, max_steps=3, top_k=4, threshold=0.08, cap_links=80):
    ...
    fig.update_layout(
        ...
        title=f"Career Path Explorer (Sankey) — {max_steps}-step expansion",
    )
...
# -----------------------------
# Page: Career Path Explorer (Sankey)
# -----------------------------
elif page == "Career Path Explorer (Sankey)":
